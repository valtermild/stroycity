    ...
    render(){
        return(
            <div>
                <Helmet>
                <meta charSet="utf-8" />
                <title>Общестроительные работы от компании "СТРОЙ СИТИ ГРУПП" | Строительная компания в Ялте</title>
                <meta name="description" content="Все виды общестроительных и подготовительных работ при строительстве зданий" />
                </Helmet>
                {/* Navigation bar */}
                <NavBar/>
