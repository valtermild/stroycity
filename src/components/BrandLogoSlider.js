...
class BrandLogoSlider extends Component{
    render(){
        ...
        let data = [
            {img: 'logo1.jpg', logoLink: '/'},
            {img: 'logo2.jpg', logoLink: '/'},
            {img: 'logo3.jpg', logoLink: '/'},
            {img: 'logo4.jpg', logoLink: '/'},
            {img: 'logo5.jpg', logoLink: '/'},
            {img: 'logo6.jpg', logoLink: '/'},
            {img: 'logo7.jpg', logoLink: '/'},
            {img: 'logo8.jpg', logoLink: '/'}
        ];
